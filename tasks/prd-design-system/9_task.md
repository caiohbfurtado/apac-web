...
- Adicionar um playground na home (`app/page.tsx`) exibindo o `Footer` com conteúdo realista e links principais.
</requirements>
...
- A home passa a demonstrar o `Footer` em contexto (final da página), facilitando validação manual rápida.
