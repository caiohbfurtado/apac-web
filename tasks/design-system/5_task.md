# Tarefa 5.0: Criar componentes de apoio visual
...
- [ ] 5.1 Implementar `Badge` com tons adequados ao sistema institucional.
- [ ] 5.2 Implementar `Card` como base de superfície reutilizável para blocos de conteúdo.
- [ ] 5.3 Validar composição com tipografia, botões e seções.
- [ ] 5.4 Escrever testes de variantes, estrutura e estados interativos.
