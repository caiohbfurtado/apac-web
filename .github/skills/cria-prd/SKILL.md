---
name: cria-prd
description: Creates Product Requirements Documents (PRDs) for frontend features and content initiatives in this NGO website, following a structured workflow of clarification, planning, and drafting. Outputs a standardized PRD to the project tasks directory. Use when the user asks to create a PRD, define requirements, or document a new page, section, campaign, flow, or site improvement. Do not use for technical specifications, task breakdowns, or direct implementation planning.
---
...
2. Cover all areas from the clarification checklist:
   ...
   - **Core Functionality**: Content, actions, key user journeys, CTAs.
   - **Scope and Planning**: What is NOT included, dependencies.
   - **Design and Experience**: UI/UX guidelines, accessibility, content tone, SEO expectations.
...
1. Create a development plan including:
   ...
   - Areas requiring research when the feature depends on external rules, accessibility guidance, SEO practices, donation/contact tooling, or NGO communication constraints.
...
- Prefer language suitable for an NGO website: clear messaging, trust, inclusivity, and conversion-oriented CTAs.
- Treat content strategy, information architecture, accessibility, SEO, and mobile behavior as first-class concerns.
